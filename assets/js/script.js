...
//function used to submit criteria to API
$("#exerciseSearch").submit(function (event) {
    ...
    fetch(requestUrl, {
        ...
        .then(function (data) {
            ...
            //add data returned ass input selectors within the modal
...
//functionality for remove button within saved exercises section
$(".remove-button").click(function () {
    localStorage.removeItem("workouts");
    $('.saved-exercise-body').empty();
})

//functionality for close out buttons in exercise modals
...
//function to print nutrition data from the API onto the table
